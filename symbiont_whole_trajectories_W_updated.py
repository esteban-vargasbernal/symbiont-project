...
#################
def process_simulation_task(N,c,M,x_alive,D_cell,D_sym,w_for_cells, N_gen, s_for_symbionts, s_for_cells, N_sim, h_for_symbionts, e_for_symbionts, h_for_cells, e_for_cells, epsilon_cell, epsilon_sym, gamma_cell, gamma_sym, s_cell_max, h_cell_max, e_cell_max, w_cell_max, s_sym_max,h_sym_max,e_sym_max, which_to_mutate_cell, which_to_mutate_sym):
    ...
    df = many_simulations_with_mutations(N,c,M,x_alive,x_cell,x_sym_in,x_sym_out,D_cell,D_sym, x_mut, N_gen,N_sim, which_to_mutate_cell, which_to_mutate_sym)
